/**
 * Comparison class used to comparison statistics between two countries / vertices in the
 * comparison graph. Stores information on social, health, economic, and pollution data points.
 */
